...
/**
 * Get the global share count for an article URL
 */
export const articleShareCount = <ThrowOnError extends boolean = false>(options: Options<ArticleShareCountData, ThrowOnError>): RequestResult<ArticleShareCountResponses, ArticleShareCountErrors, ThrowOnError> => (options.client ?? client).get<ArticleShareCountResponses, ArticleShareCountErrors, ThrowOnError>({ url: '/api/v1/social/share-count', ...options });
...
/**
 * Get the global star count for an article URL
 */
export const articleStarCount = <ThrowOnError extends boolean = false>(options: Options<ArticleStarCountData, ThrowOnError>): RequestResult<ArticleStarCountResponses, ArticleStarCountErrors, ThrowOnError> => (options.client ?? client).get<ArticleStarCountResponses, ArticleStarCountErrors, ThrowOnError>({ url: '/api/v1/social/star-count', ...options });
...
/**
 * Get a user's avatar image (proxied from their PDS)
 */
export const getUserAvatar = <ThrowOnError extends boolean = false>(options: Options<GetUserAvatarData, ThrowOnError>): RequestResult<GetUserAvatarResponses, GetUserAvatarErrors, ThrowOnError> => (options.client ?? client).get<GetUserAvatarResponses, GetUserAvatarErrors, ThrowOnError>({ url: '/api/v1/users/{handle}/avatar', ...options });

/**
 * Get a user's banner image (proxied from their PDS)
 */
export const getUserBanner = <ThrowOnError extends boolean = false>(options: Options<GetUserBannerData, ThrowOnError>): RequestResult<GetUserBannerResponses, GetUserBannerErrors, ThrowOnError> => (options.client ?? client).get<GetUserBannerResponses, GetUserBannerErrors, ThrowOnError>({ url: '/api/v1/users/{handle}/banner', ...options });
...
/**
 * List read history (articles you've read, most recent first)
 */
export const listHistory = <ThrowOnError extends boolean = false>(options?: Options<ListHistoryData, ThrowOnError>): RequestResult<ListHistoryResponses, ListHistoryErrors, ThrowOnError> => (options?.client ?? client).get<ListHistoryResponses, ListHistoryErrors, ThrowOnError>({ url: '/v1/history', ...options });
 ...
 */
export const deleteMeAvatar = <ThrowOnError extends boolean = false>(options?: Options<DeleteMeAvatarData, ThrowOnError>): RequestResult<DeleteMeAvatarResponses, DeleteMeAvatarErrors, ThrowOnError> => (options?.client ?? client).delete<DeleteMeAvatarResponses, DeleteMeAvatarErrors, ThrowOnError>({ url: '/v1/me/avatar', ...options });

/**
 * Upload current user's avatar
 */
export const uploadMeAvatar = <ThrowOnError extends boolean = false>(options?: Options<UploadMeAvatarData, ThrowOnError>): RequestResult<UploadMeAvatarResponses, UploadMeAvatarErrors, ThrowOnError> => (options?.client ?? client).post<UploadMeAvatarResponses, UploadMeAvatarErrors, ThrowOnError>({
...
/**
 * Mark current user onboarding complete
 */
export const completeMeOnboarding = <ThrowOnError extends boolean = false>(options?: Options<CompleteMeOnboardingData, ThrowOnError>): RequestResult<CompleteMeOnboardingResponses, CompleteMeOnboardingErrors, ThrowOnError> => (options?.client ?? client).post<CompleteMeOnboardingResponses, CompleteMeOnboardingErrors, ThrowOnError>({ url: '/v1/me/onboarding', ...options });
