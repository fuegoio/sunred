 ...
 * snippet, a right-side comments button, and a bottom-right footer with
 * the repost/star actions. Element heights match the real card's
 * line-heights (text-xs = 16px, text-sm = 20px, icon-sm = 32px) so borders
 * don't jump when data replaces the skeleton.
 */
